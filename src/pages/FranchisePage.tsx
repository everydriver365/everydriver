        ...
        <div className="container max-w-6xl space-y-12">
          ...
          >
            <Badge className="bg-accent/20 text-accent border-accent/30 text-xs font-semibold px-3 py-1">
              <Heart className="w-3 h-3 mr-1" /> INCLUDED IN YOUR FRANCHISE FEE
            </Badge>
            ...
            <p className="text-primary-foreground/60 max-w-2xl mx-auto text-lg">
              Your business gets all this as standard. No extras, no hidden costs — comprehensive private healthcare included with every franchise tier.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {healthcareCategories.map((cat, i) => (
              <motion.div
                ...
                className="bg-primary-foreground/5 border border-primary-foreground/10 rounded-2xl p-5 space-y-4 hover:bg-primary-foreground/8 transition-colors"
              >
