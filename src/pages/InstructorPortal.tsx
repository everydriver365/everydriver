            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="relative">
                ...
                {pupilSearch.length > 0 && (
                  <div className="absolute top-full left-0 mt-1.5 w-80 bg-popover border border-border rounded-xl shadow-xl z-50 max-h-72 overflow-y-auto">
                    {pupils
                            ...
                            .map(pupil => (
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  <div className="text-sm font-medium truncate text-popover-foreground">{pupil.name}</div>
