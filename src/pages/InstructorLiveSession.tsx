          ...
          {viewMode === "fleet" ? (
            ...
            <>
              ...
              <div style={{
                ...
                {(
                  [
                    { key: "liveLesson", label: "Live lesson", subtitle: "Track with a pupil · records route", iconBg: "#1F3A8A", iconColor: "#FFF", Icon: Play },
                    { key: "testRoute", label: "Test route", subtitle: "Practice route without a pupil", iconBg: "#EEF3FF", iconColor: "#1F3A8A", Icon: MapPin },
                    ...
                    <div key={mode.key}>
                      ...
                      >
                        <div style={{
                          ...
                          background: active ? "#1F3A8A" : mode.iconBg,
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{
                            ...
                            color: active ? "#1F3A8A" : "#1A1A1A",
                          }}>{mode.label}</div>
                          <div style={{ fontSize: 10, color: "#8E8E93", marginTop: 1 }}>{mode.subtitle}</div>
                        </div>
                        <div style={{
                          width: 18, height: 18, borderRadius: 9,
                          border: `${active ? 2 : 1.5}px solid ${active ? "#1F3A8A" : "#E0E5EE"}`,
                          display: "flex", alignItems: "center", justifyContent: "center",
                        }}>
                          {active && <span style={{ width: 8, height: 8, borderRadius: 4, background: "#1F3A8A" }} />}
                        </div>
                      </button>
                      {idx < arr.length - 1 && (
                ...
                return (
                  <>
                    <button
                      ...
                      disabled={!canStart}
                      style={{
                        width: "100%", background: canStart ? "#1F3A8A" : "#C7C7CC",
