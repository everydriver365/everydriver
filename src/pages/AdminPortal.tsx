...
const sectionMeta: Record<string, { title: string; group: string; icon: React.ElementType }> = {
  ...
  "ai-voice": { title: "Telephone Calls and Answering", group: "Communications", icon: MessageCircle },
  // Analytics
        ...
        return (
          <>
            ...
            <div className="grid gap-3 md:grid-cols-3 mt-4">
              ...
              <Link to="/admin/eol-audit" className="block">
                <Card className="hover:bg-accent/50 transition-colors cursor-pointer h-full">
                  <CardContent className="pt-6">
                    <div className="text-sm font-medium">EOL Audit Log</div>
                    <div className="text-xs text-muted-foreground">Who tapped Done & when records were created</div>
                  </CardContent>
                </Card>
              </Link>
            </div>
