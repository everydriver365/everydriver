    ...
    <InstructorPortalLayout>
      <div className="space-y-4 pb-24">
        ...
        <motion.div
          ...
          className="rounded-none border-l-4 border-l-primary p-4 text-white bg-gradient-to-br from-primary via-primary/85 to-primary/70"
        >
          <div className="flex items-center justify-between">
            <div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <motion.div
            ...
            className="bg-card rounded-none border p-3 text-center"
          >
        ...
        <motion.div
          ...
          className="bg-card rounded-none border border-l-4 border-l-primary p-4"
        >
          <WeeklyComparisonBar 
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link to="/instructor/accounts">
            <motion.div
              ...
              className="bg-card rounded-none border border-l-4 border-l-primary p-4 hover:bg-muted/50 transition-colors h-full"
            >
        ...
        <motion.div
          ...
          className="bg-card rounded-none border border-l-4 border-l-primary"
        >
