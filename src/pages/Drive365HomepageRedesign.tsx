...
import {
  ArrowRight, Check, Star, Shield, Users, Calendar, Award, Heart,
  ChevronRight, Smartphone, Monitor, Globe, Clock, CreditCard, User,
  Zap, MapPin, Play
} from "lucide-react";
    ...
    <MainLayout>
      ...
      <section className="relative min-h-[600px] overflow-hidden bg-white py-12 lg:py-20">
        <div className="container relative">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-2 font-semibold text-foreground">{hero.rating_value}</span>
                </div>
            ...
            >
              <img src={heroMobile} alt="Happy learner driver" className="w-full max-w-sm mx-auto rounded-2xl shadow-lg" />
            </motion.div>
            ...
            >
              ...
              >
                <div className="relative w-40 lg:w-48">
                  <img src={testimonialSarah} alt="Sarah" className="w-full aspect-[4/5] object-cover" />
              ...
              >
                <div className="relative w-36 lg:w-44">
                  <img src={testimonialJames} alt="James" className="w-full aspect-[4/5] object-cover" />
                  <div className="pt-3 pb-1 text-center">
              ...
              >
                <div className="relative w-44 lg:w-52">
                  <img src={testimonialEmma} alt="Emma" className="w-full aspect-[4/5] object-cover" />
                  <div className="pt-3 pb-1 text-center">
              ...
              >
                <div className="relative w-32 lg:w-40">
                  <img src={testimonialPriya} alt="Priya" className="w-full aspect-[4/5] object-cover" />
                  <div className="pt-3 pb-1 text-center">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="font-bold">{hero.learners_count} {hero.learners_label}</div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              <div className="relative h-48 overflow-hidden">
                <img src={courseIntensiveImg} alt="Intensive Courses" className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" />
            ...
            >
              <div className="relative h-48 overflow-hidden">
                <img src={courseSemiIntensiveImg} alt="Semi-Intensive Courses" className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" />
            ...
            >
              <div className="relative h-48 overflow-hidden">
                <img src={courseWeeklyImg} alt="Weekly Lessons" className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" />
      ...
      <section className="bg-background py-16">
        <div className="container">
          <motion.div
            ...
            className="text-center"
          >
            <Badge className="mb-4 border-0 bg-primary text-primary-foreground">Why Learners Love Us</Badge>
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">What's Included With Every Course</h2>
            <p className="mx-auto mb-12 max-w-2xl text-muted-foreground">Everything you need to pass your driving test, all included for free.</p>
          </motion.div>
              ...
              return (
                ...
                >
                  <div className="relative h-40 overflow-hidden">
                    {featureImage ? (
                      <img src={featureImage} alt={feature.title} className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" />
                    ) : (
      ...
      <section className="bg-background py-16">
        <div className="container">
          ...
          >
            <div>
              <Badge className="mb-2 border-0 bg-primary text-primary-foreground">Available Now</Badge>
          ...
          <div className="mt-6 text-center sm:hidden">
            <Link to="/courses">
              <Button className="gap-2">View All Courses <ArrowRight className="h-4 w-4" /></Button>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <Link to="/courses">
                <Button className="gap-2">Start Your Journey <ArrowRight className="h-4 w-4" /></Button>
              </Link>
            </motion.div>
            ...
            >
              <div className="rounded-xl bg-card p-4 shadow-md">
                <div className="flex gap-4">
                  <img src={testimonialSarahM} alt="Sarah M." className="h-12 w-12 rounded-full object-cover" />
                  <div className="flex-1">
                    <div className="mb-1 flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (<Star key={i} className="h-4 w-4 fill-amber-400 text-amber-400" />))}
                    </div>
                    <p className="mb-2 text-sm text-muted-foreground">"The intensive course was exactly what I needed. My instructor was patient and really focused on my weak points."</p>
                    <div className="text-sm"><span className="font-semibold">Sarah M.</span><span className="text-muted-foreground"> • 5-Day Intensive</span></div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl bg-card p-4 shadow-md">
                <div className="flex gap-4">
                  <img src={testimonialEmily} alt="Emily R." className="h-12 w-12 rounded-full object-cover" />
                  <div className="flex-1">
                    <div className="mb-1 flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (<Star key={i} className="h-4 w-4 fill-amber-400 text-amber-400" />))}
                    </div>
                    <p className="mb-2 text-sm text-muted-foreground">"I went from being terrified of roundabouts to navigating them with ease. Best decision I ever made."</p>
                    <div className="text-sm"><span className="font-semibold">Emily R.</span><span className="text-muted-foreground"> • Semi-Intensive</span></div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl bg-card p-4 shadow-md">
                <div className="flex gap-4">
                  <img src={testimonialPriya} alt="Priya T." className="h-12 w-12 rounded-full object-cover" />
                  <div className="flex-1">
                    <div className="mb-1 flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (<Star key={i} className="h-4 w-4 fill-amber-400 text-amber-400" />))}
                    </div>
                    <p className="mb-2 text-sm text-muted-foreground">"Working full-time made it hard to learn, but the flexible scheduling meant I could fit lessons around my job."</p>
                    <div className="text-sm"><span className="font-semibold">Priya T.</span><span className="text-muted-foreground"> • 10-Day Course</span></div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              <div className="relative overflow-hidden rounded-2xl shadow-xl">
                <img src={videoThumbnailImg} alt="Our Story Video" className="h-full w-full object-cover" />
                <button
              ...
              <p className="mt-4 text-center italic text-muted-foreground">Our Story - Watch Now!</p>
            </motion.div>
            ...
            >
              <Badge className="mb-4 gap-1 border-0 bg-amber-500 text-white hover:bg-amber-500">
                <Play className="h-3 w-3 fill-white" /> Watch Our Story
              </Badge>
              <h2 className="mb-4 text-3xl font-bold md:text-4xl">Every Driver Has a Story</h2>
              <p className="mb-8 text-lg text-muted-foreground">
              ...
              <div className="flex flex-wrap gap-4">
                <Button onClick={() => welcomeVideoUrl && setVideoModalOpen(true)} className="gap-2 bg-amber-500 hover:bg-amber-600" disabled={!welcomeVideoUrl}>
        ...
        <DialogContent className="max-w-4xl p-0 overflow-hidden bg-black">
          <div className="aspect-video">
            {welcomeVideoUrl && videoModalOpen && (
              <video src={welcomeVideoUrl} className="h-full w-full" controls autoPlay />
            )}
          </div>
        </DialogContent>
      </Dialog>
        ...
        <div className="container">
          ...
          {newsLoading ? (
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              >
                <img src={dvsaNews[0].imageUrl || newsFeatured} alt={dvsaNews[0].title} className="h-80 w-full object-cover transition-transform duration-300 group-hover:scale-105 md:h-96" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <Badge className="mb-3 border-0 bg-primary text-primary-foreground">{dvsaNews[0].category || "DVSA News"}</Badge>
                  <h3 className="mb-2 text-xl font-bold text-white md:text-2xl">{dvsaNews[0].title}</h3>
                  <p className="text-sm text-white/80 line-clamp-2">{dvsaNews[0].description}</p>
                </div>
              </motion.a>
              ...
              <div className="flex flex-col gap-6">
                {dvsaNews.slice(1, 3).map((article, index) => (
                  ...
                  >
                    <img src={article.imageUrl || (index === 0 ? newsArticle1 : newsArticle2)} alt={article.title} className="h-24 w-24 flex-shrink-0 rounded-lg object-cover" />
                    <div className="flex flex-col justify-center min-w-0">
                      <Badge className="mb-1 w-fit border-0 bg-primary/10 text-primary text-xs">{article.category || "DVSA News"}</Badge>
                      <h4 className="mb-1 font-semibold group-hover:text-primary transition-colors line-clamp-2">{article.title}</h4>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }}>
                  <a href="https://despatch.blog.gov.uk/" target="_blank" rel="noopener noreferrer">
                    <Button className="w-full gap-2">Read More Articles <ArrowRight className="h-4 w-4" /></Button>
                  </a>
                </motion.div>
              </div>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="group relative overflow-hidden rounded-2xl">
                <img src={newsFeatured} alt="Road safety news" className="h-80 w-full object-cover transition-transform duration-300 group-hover:scale-105 md:h-96" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <Badge className="mb-3 border-0 bg-primary text-primary-foreground">Driving News</Badge>
                  <h3 className="mb-2 text-xl font-bold text-white md:text-2xl">Latest DVSA News & Updates</h3>
                  <p className="text-sm text-white/80">Stay up to date with the latest driving test news and instructor updates from DVSA.</p>
                </div>
              </motion.div>
              <div className="flex flex-col gap-6">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} viewport={{ once: true }} className="group flex gap-4 rounded-xl bg-card p-4 shadow-md">
                ...
                <a href="https://despatch.blog.gov.uk/" target="_blank" rel="noopener noreferrer">
                  <Button className="w-full gap-2">Visit DVSA Blog <ArrowRight className="h-4 w-4" /></Button>
                </a>
              </div>
            </div>
          )}
      ...
      <section className="container py-24">
        <div className="mx-auto max-w-2xl text-center">
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="mb-4 text-3xl font-bold md:text-4xl">
            Everything You Need to <span className="text-accent">Learn to Drive</span>
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} viewport={{ once: true }} className="text-lg text-muted-foreground">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          <Link to="/pupil/login">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="group rounded-2xl border p-6 transition-all hover:border-accent/50 hover:shadow-lg cursor-pointer h-full" style={{ backgroundColor: "#e9f4f9" }}>
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground"><User className="h-6 w-6" /></div>
          ...
          <Link to="/parent">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} viewport={{ once: true }} className="group rounded-2xl border p-6 transition-all hover:border-accent/50 hover:shadow-lg cursor-pointer h-full" style={{ backgroundColor: "#e9f4f9" }}>
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground"><Users className="h-6 w-6" /></div>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          {[
            { icon: Calendar, title: "Live Availability", desc: "Real-time calendar sync shows you exactly when instructors are free to book." },
            { icon: MapPin, title: "Local Instructors", desc: "Find certified instructors near you by postcode with adjustable search radius." },
            { icon: Award, title: "Track Progress", desc: "Monitor your learning journey with detailed progress reports and skill assessments." },
          ].map((item, index) => (
            <motion.div key={item.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 + index * 0.1 }} viewport={{ once: true }} className="group rounded-2xl border p-6 transition-all hover:border-accent/50 hover:shadow-lg" style={{ backgroundColor: "#e9f4f9" }}>
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground"><item.icon className="h-6 w-6" /></div>
      ...
      <section className="bg-secondary/50 py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="mb-4 text-3xl font-bold md:text-4xl">
              Trusted by Thousands of <span className="text-accent">Happy Drivers</span>
            </motion.h2>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  {testimonial.photo_url ? (
                    <img src={testimonial.photo_url} alt={testimonial.name} className="h-10 w-10 rounded-full object-cover" />
                  ) : (
      ...
      <section className="container py-24">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-xl text-lg text-primary-foreground/80">
            Join thousands of learners who have passed their test with Every Driver. Book your first lesson today.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link to="/courses">
              <Button variant="hero" size="xl">
                Find a Lesson <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link to="/about">
      ...
      <section className="hidden md:block border-t bg-muted/30 py-6">
        <div className="container">
          <div className="flex items-center justify-center gap-8">
            <img src={logoAdiCode} alt="ADI Code of Practice" className="h-10 object-contain" />
            <img src={logoMsa} alt="MSA GB - For all driver trainers" className="h-10 object-contain" />
            <img src={logoCpd} alt="Continuing Professional Development" className="h-10 object-contain" />
            <div className="h-8 w-px bg-border" />
            <img src={logoCardPayments} alt="Visa, MasterCard, Maestro, JCB" className="h-7 object-contain" />
            <img src={logoKlarna} alt="Klarna" className="h-7 object-contain rounded-md" />
            <img src={logoClearpay} alt="Clearpay" className="h-7 object-contain rounded-md" />
          </div>
        </div>
      </section>
