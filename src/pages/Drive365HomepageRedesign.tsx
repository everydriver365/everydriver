...
import {
  ...
  Play, ChevronRight, Clock, CreditCard, User, Zap, MapPin
} from "lucide-react";
    ...
    <MainLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <motion.div
                ...
                className="absolute top-0 left-0 lg:left-4 bg-card p-2 rounded-sm shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] z-10"
              >
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05, zIndex: 50 }}
                transition={{ type: "spring", stiffness: 100 }}
                className="absolute -top-4 right-24 lg:right-32 bg-card p-2 rounded-sm shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] z-20"
              >
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05, zIndex: 50 }}
                transition={{ type: "spring", stiffness: 100 }}
                className="absolute bottom-0 left-16 lg:left-20 bg-card p-2 rounded-sm shadow-[0_15px_50px_-10px_rgba(0,0,0,0.35)] z-30"
              >
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05, zIndex: 50 }}
                transition={{ type: "spring", stiffness: 100 }}
                className="absolute bottom-16 right-8 lg:right-12 bg-card p-2 rounded-sm shadow-[0_12px_45px_-10px_rgba(0,0,0,0.32)] z-25"
              >
            ...
            {includedFeatures.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group overflow-hidden rounded-2xl shadow-md transition-shadow hover:shadow-xl cursor-pointer bg-card"
      ...
      <section className="container py-24">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          <Link to="/pupil/login">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="group rounded-2xl border bg-card p-6 transition-all hover:border-accent/50 hover:shadow-lg cursor-pointer h-full">
          ...
          <Link to="/parent">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} viewport={{ once: true }} className="group rounded-2xl border bg-card p-6 transition-all hover:border-accent/50 hover:shadow-lg cursor-pointer h-full">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }} className="group rounded-2xl border bg-card p-6 transition-all hover:border-accent/50 hover:shadow-lg">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} viewport={{ once: true }} className="group rounded-2xl border bg-card p-6 transition-all hover:border-accent/50 hover:shadow-lg">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} viewport={{ once: true }} className="group rounded-2xl border bg-card p-6 transition-all hover:border-accent/50 hover:shadow-lg">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
