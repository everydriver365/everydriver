  ...
  return (
    <MainLayout>
      ...
      <Drive365Home
        afterHero={
          <>
          {/* Why book through Every Driver moved up; test swap banner now below it */}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, maxWidth: 1100, margin: "0 auto" }}>
                ...
                <div style={{ background: "#FFFFFF", borderRadius: 12, padding: "0.75rem 1rem", display: "flex", alignItems: "flex-start", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div className="font-medium text-xs" style={{ color: "#5A6B82", lineHeight: 1.4 }}>24/7 online booking</div>
                  </div>
                </div>
