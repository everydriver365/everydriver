...
import { PremiumScheduleView } from "@/components/instructor/schedule/PremiumScheduleView";
...
export default function InstructorSchedule() {
  ...
  // Mobile: use the premium schedule view
  if (isMobile) {
    return (
      <InstructorPortalLayout hideHeader>
        <PremiumScheduleView
          instructorId={instructorId}
          onMenuClick={() => navigate("/instructor/menu")}
        />
      </InstructorPortalLayout>
    );
  }
