        ...
        <div className="container max-w-6xl">
          ...
          <div className="space-y-5">
            {[
              ...
              { icon: Globe, name: "All-In", desc: "Everything you need to run your business — website, custom domain, online booking and marketing tools.", price: "£4.99", suffix: "/mo", free: false, benefits: ["Custom .co.uk domain", "Online booking", "SEO optimised", "Review showcase"], link: "/instructor-app/domains", img: websiteShowcaseImg },
              { icon: MapPin, name: "GPS + Health", desc: "Live GPS tracking, mileage logging, and route replay — plus Basic Health cover included.", price: "£29.99", suffix: "/mo", free: false, benefits: ["Live GPS tracking", "Mileage logging", "Basic Health cover", "All All-In features"], link: "/instructor-app/telematics", img: telematicsShowcaseImg },
              { icon: Camera, name: "Dashcam + Health", desc: "Forward-facing dashcam protection with Enhanced Health cover — dental, optical, GP & more.", price: "£49.99", suffix: "/mo", free: false, benefits: ["Dashcam protection", "Enhanced Health cover", "Cloud storage", "All GPS features"], link: "/instructor-app/dashcam", img: dashcamImg },
            ].map((product) => (
              <Link
                key={product.name}
                to={product.link}
