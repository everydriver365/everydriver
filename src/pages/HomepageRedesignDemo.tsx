        ...
        <div className="container max-w-6xl">
          ...
          <div className="space-y-5">
            {[
              ...
              { icon: Camera, name: "Dashcam + Health", desc: "Forward-facing dashcam protection with Enhanced Health cover — dental, optical, GP & more.", price: "£59.99", suffix: "/mo", free: false, benefits: ["Dashcam protection", "Enhanced Health cover", "Cloud storage", "All GPS features"], link: "/instructor-app/dashcam", img: dashcamImg },
            ].map((product) => (
              <Link
                key={product.name}
                to={product.link}
