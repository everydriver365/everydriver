...
const featureData: FeatureRow[] = [
  {
    category: "Core",
    features: [
      { name: "Lesson diary & scheduling", values: [true, true, true, true] },
      { name: "Active pupils", values: ["10", "Unlimited", "Unlimited", "Unlimited"] },
      { name: "Pupil progress tracking", values: [true, true, true, true] },
      { name: "Basic messaging", values: [true, true, true, true] },
      { name: "Pupil portal", values: [true, true, true, true] },
    ],
  },
  {
    category: "Business Tools",
    features: [
      { name: "Online booking page", values: [false, true, true, true] },
      { name: "Card payments (Square)", values: [false, true, true, true] },
      { name: "Bank payments (GoCardless)", values: [false, true, true, true] },
      { name: "Cash payment tracking", values: [false, true, true, true] },
      { name: "Parent portal", values: [false, true, true, true] },
      { name: "Pupil app access", values: [false, true, true, true] },
      { name: "Broadcast messaging", values: [false, true, true, true] },
      { name: "Performance analytics", values: [false, true, true, true] },
      { name: "Mini website builder", values: [false, true, true, true] },
    ],
  },
  {
    category: "GPS & Tracking",
    features: [
      { name: "Live vehicle tracking", values: [false, false, true, true] },
      { name: "Route recording", values: [false, false, true, true] },
      { name: "Automatic mileage logging", values: [false, false, true, true] },
      { name: "Driver behaviour scores", values: [false, false, true, true] },
      { name: "Speed & harsh event alerts", values: [false, false, true, true] },
      { name: "Geofence zones", values: [false, false, true, true] },
      { name: "Fleet overview map", values: [false, false, true, true] },
    ],
  },
  {
    category: "Dashcam",
    features: [
      { name: "Forward-facing camera", values: [false, false, false, true] },
      { name: "Incident recording", values: [false, false, false, true] },
      { name: "Cloud video storage", values: [false, false, false, true] },
      { name: "Event-triggered clips", values: [false, false, false, true] },
      { name: "Insurance evidence export", values: [false, false, false, true] },
    ],
  },
  {
