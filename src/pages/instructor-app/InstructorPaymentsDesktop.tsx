    ...
    >
      <div className="flex flex-col" style={{ gap: 14 }}>
        ...
        <div className="grid grid-cols-4" style={{ gap: 8 }}>
          <StatCard variant="emerald" label={`NET RECEIVED · ${new Date().toLocaleString("en-GB", { month: "short" }).toUpperCase()}`} value={gbp(stats.receivedMonth)} sub={`Gross ${gbp(stats.grossMonth)} · Refunds −${gbp(stats.refundsMonth)} · ${stats.receivedCount} payments`} />
