     ...
     <div className="min-h-[calc(100dvh-120px)] bg-background -mx-4 -mt-4 p-4">
      <div className="space-y-6 max-w-2xl mx-auto">
       {/* Active Provider Banner */}
        {activeProvider && (
          <div className="overflow-hidden" style={{ backgroundColor: "#FFFFFF", borderRadius: 14, border: "0.5px solid #E4E4E7" }} p-4">
        ...
        {/* Register New Device */}
        <div className="overflow-hidden" style={{ backgroundColor: "#FFFFFF", borderRadius: 14, border: "0.5px solid #E4E4E7" }} p-4 space-y-4">
        ...
        <div className="space-y-3">
          ...
          {devices.length === 0 ? (
            <div className="overflow-hidden" style={{ backgroundColor: "#FFFFFF", borderRadius: 14, border: "0.5px solid #E4E4E7" }} py-8 text-center text-muted-foreground">
            ...
            devices.map((device) => (
              <div key={device.id} className="overflow-hidden" style={{ backgroundColor: "#FFFFFF", borderRadius: 14, border: "0.5px solid #E4E4E7" }} p-4">
