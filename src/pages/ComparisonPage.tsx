      ...
      <div className="max-w-[1200px] mx-auto px-4 py-12 md:py-16">
        ...
        <div className="hidden md:block">
          <div className="rounded-2xl border overflow-hidden shadow-sm">
            ...
            {[
              ...
              { feature: "Forward & cabin dashcam", ed: "From £49.99/mo", td: false, mdt: false, adi: false, health: false },
        ...
        <div className="md:hidden space-y-3">
          {[
            ...
            { feature: "Forward & cabin dashcam", ed: "£49.99/mo", others: "Not available", health: false },
