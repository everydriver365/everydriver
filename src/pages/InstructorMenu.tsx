...
const allTiles: TileDef[] = [
  ...
  { id: "famulor", title: "Telephone Calls and Answering", description: "Calls, campaigns, agents & analytics — Famulor", icon: Mic, tintBg: "#EDF2FE", tintColor: "#1A52A0", category: "preferences" },
