...
export function CommandPalette({ variant = "instructor" }: CommandPaletteProps) {
  ...
  const instructorActions: CommandAction[] = useMemo(() => [
    ...
    { id: "live-tracking", label: "Live Tracking", icon: Navigation, action: () => navigate("/instructor/tracking"), group: "navigation", keywords: ["gps", "driving", "route", "track", "lesson", "pupils", "map", "realtime", "monitor"] },
