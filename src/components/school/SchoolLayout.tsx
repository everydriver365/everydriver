...
const sidebarGroups: PortalNavGroup[] = [
  ...
  },
  {
    ...
    items: [
     ...
     { key: "course-summaries", label: "Course Summaries", icon: GraduationCap },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "ai-voice", label: "Telephone Calls and Answering", icon: PhoneCall },
    ],
  },
  {
    label: "Settings",
...
const sectionMeta: Record<string, { title: string; group: string }> = {
  ...
  "course-summaries": { title: "Course Summaries", group: "Management" },
  ...
  "ai-voice": { title: "Telephone Calls and Answering", group: "Engagement" },
