...
export function LessonPrepCard({ instructorId, pupilId, pupilName }: LessonPrepCardProps) {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="bg-gradient-to-r from-emerald-50/80 to-teal-50/80 dark:from-emerald-950/20 dark:to-teal-950/20 border border-emerald-200/40 dark:border-emerald-800/30 rounded-2xl p-3 mt-2"
    >
      {/* Header */}
          ...
          >
            ...
            <div className="flex gap-1 mt-2.5 mb-2 border-b border-emerald-200/30 dark:border-emerald-800/20 pb-1.5">
              {tabs.map(tab => (
                <button
                  ...
                  className={`flex items-center gap-1 px-2 py-1 rounded-2xl text-[10px] font-medium transition-colors ${
                    activeTab === tab.key
            ...
            {activeTab === "notes" && previousNotes && (
              <div className="space-y-2">
                ...
                {previousNotes.notes && (
                  <div className="bg-card/60 rounded-2xl p-2.5 border border-border/30">
                ...
                {previousNotes.nextPlan && (
                  <div className="bg-emerald-100/50 dark:bg-emerald-900/20 rounded-2xl p-2.5 border border-emerald-200/30 dark:border-emerald-800/20">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {syllabus.weakAreas.map((area) => (
                        <div key={area.id} className="flex items-center gap-2 bg-card/60 rounded-2xl px-2 py-1.5 border border-border/20">
