    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-center gap-3">
        {MOODS.map((m) => {
          const Icon = m.icon;
          return (
            <button key={m.score} onClick={() => setSelectedMood(m.score)} className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-all ${selectedMood === m.score ? "bg-primary/10 scale-110 ring-2 ring-primary" : "hover:bg-secondary"}`}>
