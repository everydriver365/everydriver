            ...
            <>
              ...
              >
                ...
                >
                  ...
                  >
                    <ChevronLeft size={14} color="#1A52A0" />
                  </button>
                  ...
                  >
                    <ChevronRight size={14} color="#1A52A0" />
                  </button>
                </div>
                ...
                >
                  <LegendItem dot="#1A52A0" label="Selected" />
                    ...
                    if (isSelected) {
                      return (
                        <button
                          ...
                          style={{ ...baseStyle, background: "#1A52A0" }}
                        >
              ...
              >
                ...
                <Switch
                  ...
                  style={{ background: notifyPupil ? "#1A52A0" : "#E0E5EE" }}
                />
              </div>
              ...
              {selectedDate && selectedTime && (
                ...
                >
                  <Clock size={14} color="#1A52A0" style={{ marginTop: 2, flexShrink: 0 }} />
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: "#1A52A0", marginBottom: 2 }}>
                      New lesson time
                    </div>
              ...
              <button
                ...
                style={{
                  background: selectedDate && selectedTime && !saving ? "#1A52A0" : "#C7C7CC",
                  borderRadius: 14,
                  padding: 14,
                  display: "flex",
                  alignItems: "center",
