...
function ColorPicker({ label, value, onChange }: ColorPickerProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      {showPresets && (
        <div className="grid grid-cols-6 gap-1.5 p-2 bg-muted rounded-lg">
          {COLOR_PRESETS.map((color) => (
            <button
              key={color}
              type="button"
              className="w-7 h-7 rounded-md border border-border/50 hover:scale-110 transition-transform relative"
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div 
                className="p-2 rounded-md text-white text-xs font-medium text-center"
