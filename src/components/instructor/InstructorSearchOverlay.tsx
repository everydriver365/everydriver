...
const groupConfig = {
  Tools: { chipBg: "#EEF3FF", chipText: "#1F3A8A" },
...
function HighlightedText({ text, query }: { text: string; query: string }) {
  ...
  return (
    <span style={{ fontSize: 12, fontWeight: 600, color: "#1A1A1A" }}>
      {text.slice(0, idx)}
      <span style={{ color: "#1F3A8A", fontWeight: 700 }}>
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: 10,
            borderBottom: isActive ? "1px solid #1F3A8A" : "0.5px solid #F0F3F8",
          }}
        >
          <SearchIcon size={15} color="#1F3A8A" strokeWidth={2} />
          <input
            ref={inputRef}
            value={query}
