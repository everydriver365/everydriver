...
export function HomepageHero({
  ...
  const stats = [
    {
      ...
      label: "This week",
      iconBg: "rgba(31,134,255,0.14)",
      iconColor: "#1F86FF",
      tileBg: "rgba(31,134,255,0.08)",
      highlight: false,
    ...
    },
    {
      ...
      label: "Earnings",
      iconBg: "rgba(28,28,30,0.10)",
      iconColor: "#1C1C1E",
      tileBg: "rgba(28,28,30,0.05)",
      highlight: false,
  ...
  return (
    <div className="px-4 pt-1" style={{ fontFamily: "-apple-system, 'SF Pro Text', 'SF Pro Display', sans-serif" }}>
      <div
        style={{
          background: "#FFFFFF",
          borderRadius: 20,
