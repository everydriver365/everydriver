      ...
      <div className="flex gap-3 overflow-x-auto pb-4 snap-x snap-mandatory md:snap-none">
        {STAGES.map((stage) => {
          ...
          return (
            <div
              key={stage.value}
              className={`min-w-[260px] w-[260px] shrink-0 snap-start rounded-xl border p-3 transition-colors ${
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <Badge variant="outline" className="ml-auto text-xs">{stageLeads.length}</Badge>
              </div>
