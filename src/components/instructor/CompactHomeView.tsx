      ...
      {isNextLessonImminent ? (
        <div className="px-4 mb-4">
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2 rounded-2xl bg-card shadow-lift border border-border/40"
          >
                  ...
                  {stats.map((stat, idx) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-card rounded-2xl shadow-lift p-3 text-center border border-border/40"
