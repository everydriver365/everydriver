...
export function DoodlepadToolbar({
  ...
  return (
    <div className="absolute bottom-20 left-2 right-2 z-[600] flex flex-col gap-2 md:bottom-4 md:left-4 md:right-4">
      ...
      {/* Main toolbar */}
      <div className="flex items-center justify-center gap-1 flex-wrap bg-white/95 dark:bg-card/95 backdrop-blur rounded-xl shadow-lg border border-border/50 px-2 py-2">
        {/* Draw / Pan toggle */}
        <Button
