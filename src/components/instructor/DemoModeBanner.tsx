...
export function DemoModeBanner() {
  ...
  return (
    <div className="bg-amber-500/15 border border-amber-500/30 rounded-2xl px-4 py-2.5 flex items-center justify-between gap-3">
  ...
  return (
    <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5">
      <CardContent className="p-4 flex items-start gap-3">
        <div className="h-9 w-9 rounded-2xl bg-primary/10 flex items-center justify-center shrink-0 mt-0.5">
