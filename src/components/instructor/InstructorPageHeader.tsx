...
export function InstructorPageHeader({
  ...
  return (
    <div className={cn("flex items-center justify-between sticky top-14 z-30 py-3 -mx-4 px-4", className)} style={{ backgroundColor: 'var(--instructor-bg-overlay)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)' }}>
