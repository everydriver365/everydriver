        ...
        <div className="rounded-2xl bg-card border border-border shadow-[0_2px_12px_rgba(20,37,66,0.08)] overflow-hidden">
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-2 mb-3">
              {minutesUntil <= 30 ? (
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200/60 dark:border-amber-800/30 text-sm font-bold text-amber-700 dark:text-amber-300 animate-pulse shadow-[0_1px_4px_rgba(217,119,6,0.1)]">
