...
export const QUICK_ACCESS: QAItem[] = [
  ...
  { label: "Log test result", Icon: LogTestResultIcon, ...NAVY_BG, route: "/instructor/test-results" },
  ...
  { label: "Tax",             Icon: TaxIcon,          ...NAVY_BG, route: "/instructor/tax" },
  { label: "Reviews",         Icon: ReviewsIcon,      ...RED_BG,  route: "/instructor/reviews" },
