          ...
          >
            ...
            <div className="flex items-start gap-3 relative">
              ...
              <motion.div
                ...
                className="flex-1 bg-card rounded-none border border-border border-l-4 border-l-primary p-3 cursor-pointer
            ...
            {nextLesson && gapMinutes > 0 && (
              <div className="flex items-start gap-3 my-1 relative">
                ...
                <div className={`flex-1 py-2 px-3 rounded-none text-xs ${
