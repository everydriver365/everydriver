  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && filtered.length > 0 && (
        <div className="absolute z-50 mt-1 w-full rounded-xl bg-white dark:bg-[#1C1C1E] shadow-lg border border-border/50 max-h-64 overflow-y-auto">
          {filtered.map((item, i) => (
            <button
              key={item.id}
      ...
      {open && query.trim().length > 0 && filtered.length === 0 && (
        <div className="absolute z-50 mt-1 w-full rounded-xl bg-white dark:bg-[#1C1C1E] shadow-lg border border-border/50 p-4 text-center">
