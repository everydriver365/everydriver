...
export function UpcomingLessonMap({ instructorId }: UpcomingLessonMapProps) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center bg-muted rounded-xl h-44">
  ...
  return (
    <div className="relative rounded-xl overflow-hidden border shadow-sm">
      ...
      <div className="absolute top-3 left-3 z-10 bg-card/95 backdrop-blur-sm rounded-lg px-3 py-2 shadow-lg border">
