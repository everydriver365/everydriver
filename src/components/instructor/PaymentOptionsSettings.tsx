  ...
  const content = (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {klarnaEnabled && isPro && (
          <div className="flex items-start gap-2 p-3 bg-pink-50 dark:bg-pink-950/30 rounded-2xl border border-pink-200 dark:border-pink-800">
      ...
      <div className="space-y-2">
        ...
        {clearpayEnabled && isPro && (
          <div className="flex items-start gap-2 p-3 bg-emerald-50 dark:bg-emerald-950/30 rounded-2xl border border-emerald-200 dark:border-emerald-800">
