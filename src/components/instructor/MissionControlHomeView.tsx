    ...
    <div className="px-4 pb-6 space-y-3">
      ...
      >
        ...
        <div className="flex gap-1.5 shrink-0">
          {[
            ...
            <div key={s.label} className={cn("px-2.5 py-1.5 rounded-2xl text-center", s.color)}>
              <p className="text-sm font-bold leading-tight">{s.value}</p>
              <p className="text-[9px] opacity-70">{s.label}</p>
            </div>
          ))}
        </div>
        <div className="flex items-center gap-1.5 bg-emerald-500/10 rounded-2xl px-2.5 py-1.5 shrink-0">
      ...
      <div className="grid grid-cols-4 gap-3" style={{ minHeight: "380px" }}>
        ...
        <motion.div
          ...
          className="col-span-2 bg-card border border-border rounded-2xl overflow-hidden flex flex-col"
        >
          ...
          <div className="p-3 flex-1 overflow-y-auto space-y-2">
            {unreadCount > 0 && (
              <button
                ...
                className="w-full text-left text-xs p-2.5 rounded-2xl border border-primary/20 bg-primary/5"
              >
            ...
            {(alerts || []).slice(0, 3).map((a, i) => (
              <div key={i} className="text-xs p-2.5 rounded-2xl border border-amber-500/20 bg-amber-500/5">
                <div className="flex items-center gap-1.5">
            ...
            {gapCount > 0 && (
              <button
                ...
                className="w-full text-left text-xs p-2.5 rounded-2xl border border-border bg-muted/30"
              >
                <div className="flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {[
                ...
                <button
                  ...
                  className="relative flex flex-col items-center justify-center gap-1 p-2.5 rounded-2xl hover:bg-muted/50 transition-colors"
                >
      ...
      {nextLesson && (
        <motion.div
          ...
          className="bg-card border-2 border-primary/20 rounded-2xl overflow-hidden"
        >
          <div className="flex">
