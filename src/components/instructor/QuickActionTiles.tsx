          ...
          {localTiles[0] && (
            ...
            >
              <Link to={localTiles[0].route}>
                 <div className="relative overflow-hidden bg-white rounded-2xl p-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] active:shadow-sm transition-all border border-border border-l-2 border-l-[#1877F2]">
              ...
              return (
                <Link key={action.id} to={action.route} className="block">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.97 }}
                     className={`relative overflow-hidden ${style.bg} rounded-xl px-3 py-2.5 flex items-center gap-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] active:shadow-sm transition-shadow border border-border border-l-2 border-l-[#1877F2]`}
                  >
