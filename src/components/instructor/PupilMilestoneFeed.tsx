          ...
          {milestones.map((m, i) => {
            ...
            return (
              <motion.div
                ...
                className="shrink-0 w-44 rounded-2xl border bg-card p-3 space-y-2 shadow-sm"
              >
                ...
                <div className={cn("w-8 h-8 rounded-2xl flex items-center justify-center", colorClass)}>
