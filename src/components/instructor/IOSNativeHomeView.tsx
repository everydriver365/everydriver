  ...
  if (!nextLesson) {
    return (
      <div className="mx-4 mb-4">
        <button
          className="w-full rounded-[14px] p-5 flex items-center gap-4 bg-card"
  ...
  return (
    <div className="mx-4 mb-4">
      ...
      >
        ...
        {/* Running Late Alert */}
        {isRunningLate && (
          <div className="mx-4 mb-2 p-2.5 rounded-xl flex items-center gap-2" style={{ backgroundColor: "rgba(255,149,0,0.2)" }}>
            ...
            >
              <div className="px-4 pb-4">
                ...
                <div className="grid grid-cols-3 gap-2 mb-3">
                  <div className="bg-white/[0.08] rounded-xl py-3 px-2 text-center">
                ...
                {/* ETA Row */}
                {etaText && (
                  <div className="bg-white/[0.08] rounded-xl p-3 flex items-center gap-3 mb-3">
                ...
                {pupilUnreadCount > 0 && (
                  <button
                    ...
                    className="w-full bg-white/[0.08] rounded-xl p-3 flex items-center gap-3 mb-3"
                  >
                ...
                <div className="grid grid-cols-4 gap-2 mb-3">
                  <button
                    ...
                    className="flex flex-col items-center justify-center gap-1 bg-white/[0.12] rounded-xl py-3 min-h-[64px]"
                  >
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="flex flex-col items-center justify-center gap-1 bg-white/[0.12] rounded-xl py-3 min-h-[64px]">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="py-2.5 rounded-xl bg-white/[0.08] text-white/80 text-[13px] font-medium"
                  >
                    Reschedule
                  </button>
                  <button
                    onClick={() => setCancelOpen(true)}
                    className="py-2.5 rounded-xl text-[13px] font-medium"
