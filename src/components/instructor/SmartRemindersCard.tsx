    ...
    <div className="px-4 mt-3">
      ...
      >
        <Link to="/instructor/jobs">
          <div className="bg-gradient-to-r from-amber-500/10 via-amber-500/15 to-amber-500/10 dark:from-amber-500/15 dark:via-amber-500/20 dark:to-amber-500/15 backdrop-blur-sm rounded-xl border border-amber-500/30 p-3 flex items-center gap-3 active:scale-[0.99] transition-transform">
            {/* Icon */}
