        ...
        {SHORT_DAYS.map((d, i) => {
          ...
          return (
            <div key={i} className="text-center">
              ...
              <div className={`h-8 rounded-md flex items-center justify-center text-xs font-medium ${daySlots.length > 0 ? "bg-primary/15 text-primary" : "bg-muted text-muted-foreground"}`}>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full rounded-md border p-2 text-sm bg-background" value={day} onChange={(e) => setDay(+e.target.value)}>
