...
const statusConfig = {
  ...
  in_progress: { label: "In Progress", color: "bg-blue-100 text-blue-700 dark:bg-blue-950/50 dark:text-blue-400", icon: Play },
  ...
  return (
    <div className="bg-muted/30 rounded-lg border">
      ...
      <button
        ...
        className="w-full p-3 flex items-center justify-between text-left hover:bg-muted/50 transition-colors rounded-t-lg"
      >
