...
export function PupilCreditBreakdown({
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-blue-50/50 to-blue-100/30 dark:from-blue-950/20 dark:to-blue-900/10 rounded-lg p-3">
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50/50 to-blue-100/30 dark:from-blue-950/20 dark:to-blue-900/10 rounded-lg p-3 space-y-2">
      ...
      <div className="space-y-1.5">
        {/* Prepaid Hours */}
        {prepaidHours > 0 && (
          <div className="flex items-center justify-between bg-background/60 rounded-lg px-2.5 py-2">
            <div className="flex items-center gap-2">
        ...
        {/* Upsells */}
        {upsells.map((upsell) => (
          <div key={upsell.id} className="flex items-center justify-between bg-background/60 rounded-lg px-2.5 py-2">
            <div className="flex items-center gap-2">
