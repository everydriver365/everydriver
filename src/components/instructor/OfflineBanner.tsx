  ...
  return (
    <AnimatePresence>
      {!isOnline && !dismissed && (
        ...
        >
          <div className="flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-amber-50 dark:bg-amber-950/80 shadow-lg ring-1 ring-amber-500/30 backdrop-blur-xl">
      ...
      {showReconnected && isOnline && (
        <motion.div
          ...
          className="fixed top-[calc(env(safe-area-inset-top)+60px)] left-4 right-4 z-50"
        >
          <div className="flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-emerald-50 dark:bg-emerald-950/80 shadow-lg ring-1 ring-emerald-500/30 backdrop-blur-xl">
