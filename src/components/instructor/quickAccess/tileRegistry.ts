import {
  ...
  Megaphone, GraduationCap, Accessibility, Phone, Trophy, ShieldCheck,
  type LucideIcon,
} from "lucide-react";
...
export const QUICK_ACCESS_TILES: QuickAccessTile[] = [
  ...
  { id: "find-my-car",      title: "Find my car",      subtitle: "Last position",         icon: FindMyCarIcon,   tone: "blue",   route: "/instructor/find-my-car",       requiredFeature: "telematics" },
  ...
  { id: "locations",        title: "Locations",        subtitle: "Saved places",          icon: LocationsIcon,   tone: "blue",   route: "/instructor/locations" },
  ...
  { id: "adi-badge",        title: "ADI badge",        subtitle: "Renewal & grade",       icon: ShieldCheck,     tone: "green",  route: "/instructor/settings/account" },
];
