         ...
         <div className="grid grid-cols-2 gap-2">
           ...
           <div className="flex items-center gap-2">
             ...
             <div>
               ...
               <p className="text-sm font-semibold text-foreground">{stats.totalTrackedMiles} mi</p>
             </div>
           </div>
           ...
           <div className="flex items-center gap-2">
             ...
             <div>
               ...
               <p className="text-sm font-semibold text-foreground">{stats.sessionsThisMonth} trips</p>
             </div>
           </div>
             ...
             <div className="flex items-center gap-2">
               ...
               <div>
                 ...
                 <p className={`text-sm font-semibold ${
                   ...
                   {daysUntilTest === 0 ? "Today!" : `${daysUntilTest}d`}
                 </p>
               </div>
             </div>
           )}
