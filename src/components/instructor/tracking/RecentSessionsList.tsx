       ...
       >
         <CollapsibleTrigger className="w-full px-5 py-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-muted/30 transition-colors">
           <div className="flex items-center gap-3">
             <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-muted flex items-center justify-center">
             ...
             {isOpen && (
               ...
               >
                 {sessions.map((session, index) => (
                   <motion.button
                     key={session.id}
                     className="w-full flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-muted/50 hover:bg-slate-100 dark:hover:bg-muted transition-colors text-left"
