  ...
  return (
    <div className={cn("bg-card rounded-xl border shadow-sm overflow-hidden", className)}>
      ...
      <button
        ...
        className="w-full px-4 py-3 flex items-center justify-between bg-gradient-to-r from-primary via-primary/90 to-primary/80 text-white rounded-t-xl"
      >
...
function ManualReminderRow({ todo, onToggle, onDelete }: {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button onClick={onDelete} className="opacity-0 group-hover:opacity-100 p-1.5 rounded-md hover:bg-muted text-muted-foreground hover:text-red-500 transition-all shrink-0">
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="opacity-0 group-hover:opacity-100 flex items-center gap-0.5 transition-all shrink-0">
        <button onClick={() => setIsEditing(true)} className="p-1.5 rounded-md hover:bg-muted text-muted-foreground transition-colors">
          <Pencil className="h-3.5 w-3.5" />
        </button>
        <button onClick={onDelete} className="p-1.5 rounded-md hover:bg-muted text-muted-foreground hover:text-red-500 transition-colors">
          <Trash2 className="h-3.5 w-3.5" />
        </button>
      </div>
    </div>
