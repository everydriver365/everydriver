                ...
                >
                  <PopoverTrigger asChild>
                    <button
                      disabled={isPast}
                      className={cn(
                        "aspect-square rounded-2xl border-2 flex flex-col items-start justify-start p-2 transition-all duration-200 relative",
                        hasSlots
                  ...
                  <PopoverContent className="w-80 p-0" align="start">
                    {/* Header */}
                    <div className="flex items-center justify-between bg-primary text-primary-foreground px-4 py-3 rounded-2xl">
