    ...
    <div className="px-4 mt-4">
      ...
      >
        <Link to="/instructor/schedule">
          <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 dark:from-primary/10 dark:via-primary/15 dark:to-primary/10 backdrop-blur-sm rounded-none border border-primary/20 p-3 active:scale-[0.99] transition-transform">
            {/* Title */}
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="flex flex-col items-center justify-center text-center">
                <div className="flex items-center justify-center w-6 h-6 rounded-none bg-violet-500/15 dark:bg-violet-500/20 mb-1">
              ...
              {/* Hours */}
              <div className="flex flex-col items-center justify-center text-center">
                <div className="flex items-center justify-center w-6 h-6 rounded-none bg-primary/15 dark:bg-primary/20 mb-1">
              ...
              {/* Earnings */}
              <div className="flex flex-col items-center justify-center text-center">
                <div className="flex items-center justify-center w-6 h-6 rounded-none bg-emerald-500/15 dark:bg-emerald-500/20 mb-1">
              ...
              {/* First Pickup */}
              <div className="flex flex-col items-center justify-center text-center">
                <div className="flex items-center justify-center w-6 h-6 rounded-none bg-rose-500/15 dark:bg-rose-500/20 mb-1">
