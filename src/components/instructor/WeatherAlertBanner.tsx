...
export function WeatherAlertBanner({ className = "" }: { className?: string }) {
  ...
  return (
    <motion.div
      ...
      className={`rounded-xl border p-3 flex items-center gap-3 ${severityStyles[severity]} ${className}`}
    >
      <div className="h-9 w-9 rounded-lg bg-current/10 flex items-center justify-center shrink-0">
