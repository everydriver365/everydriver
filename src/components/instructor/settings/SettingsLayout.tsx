...
import { ChevronLeft, ChevronRight, PanelLeftClose, PanelLeftOpen, Search, User as UserIcon, type LucideIcon } from "lucide-react";
  ...
  if (isMobile) {
    ...
    return (
      <div
        ...
        style={
          isAccount
            ? { background: "#F2F4F8", margin: "0 -14px", padding: "0 5px" }
            : undefined
