  ...
  return (
    <div className="space-y-3 mt-3">
      ...
      {(todayLessons !== undefined || expectedEarnings !== undefined) && (
        <div className="flex gap-2">
          {todayLessons !== undefined && (
            <div className="flex-1 bg-primary/5 rounded-xl px-3 py-2 text-center">
          ...
          {expectedEarnings !== undefined && (
            <div className="flex-1 bg-emerald-500/5 rounded-xl px-3 py-2 text-center">
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="bg-muted/50 rounded-xl px-3 py-2 text-[11px] text-muted-foreground leading-relaxed"
      >
        {DAILY_TIPS[tipIndex]}
      </motion.div>
    </div>
