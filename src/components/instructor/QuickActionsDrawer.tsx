...
const TILE_META: Record<string, TileMeta> = {
  ...
  "messages":     { label: "Messages",     subtitle: "Send a message",Icon: MessageSquare, iconBg: "#EEF3FF", iconColor: "#2952B3" },
  "nearby-adis":  { label: "Nearby ADIs",  subtitle: "Find instructors", Icon: MapPin,  iconBg: "#EEF3FF", iconColor: "#2952B3" },
};
        ...
        >
          ...
          <div style={{ padding: 13, paddingBottom: 0 }}>
            ...
            {trailing && (() => {
              ...
              const iconColor = meta?.iconColor ?? "#2952B3";
              return (
                <button
