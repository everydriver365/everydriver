...
const TILE_META: Record<string, TileMeta> = {
  ...
  "messages":     { label: "Messages",     subtitle: "Send a message",Icon: MessageSquare, iconBg: "#EEF3FF", iconColor: "#3D55A1" },
  "nearby-adis":  { label: "Nearby ADIs",  subtitle: "Find instructors", Icon: MapPin,  iconBg: "#EEF3FF", iconColor: "#3D55A1" },
};
        ...
        >
          ...
          <div style={{ padding: 13, paddingBottom: 0 }}>
            ...
            {trailing && (() => {
              ...
              const iconColor = meta?.iconColor ?? "#3D55A1";
              return (
                <button
