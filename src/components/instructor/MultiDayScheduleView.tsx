    ...
    >
      ...
      <div style={{ padding: "0 15px", marginBottom: 14 }}>
        <div style={{ display: "flex", gap: 7 }}>
          {[
            { value: String(todaySummary.lessonCount), label: "Lessons", color: "#2952B3", small: false },
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <span style={{
                    ...
                    backgroundColor: today ? "#2952B3" : "#8E8E93",
                  }} />
                  <span style={{
                    fontSize: 11,
                    fontWeight: 700,
                    color: today ? "#2952B3" : "#8E8E93",
                ...
                <button
                  ...
                  style={{
                    backgroundColor: today ? "#2952B3" : "#FFFFFF",
