...
import { Loader2, MapPin, Video, ExternalLink, ChevronRight, User, CalendarDays, Clock, Hourglass, AlertCircle, Check, PoundSterling, FileText, Plus } from "lucide-react";
    ...
    >
      ...
      <div style={{ padding: "0 15px", marginBottom: 14 }}>
        <div style={{ display: "flex", gap: 7 }}>
          {[
            { value: String(todaySummary.lessonCount), label: "Lessons", color: "#1F3A8A", small: false },
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <span style={{
                    ...
                    backgroundColor: today ? "#1F3A8A" : "#8E8E93",
                  }} />
                  <span style={{
                    fontSize: 11,
                    fontWeight: 700,
                    color: today ? "#1F3A8A" : "#8E8E93",
                ...
                <button
                  ...
                  style={{
                    backgroundColor: today ? "#1F3A8A" : "#FFFFFF",
