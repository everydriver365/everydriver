  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mx-4 mt-4"
      >
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-2xl p-3 shadow-sm">
          <div className="flex items-start gap-3">
            {/* Icon */}
            <div className="flex-shrink-0 p-2 bg-amber-100 dark:bg-amber-800/30 rounded-2xl">
