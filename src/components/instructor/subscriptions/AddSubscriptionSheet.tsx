...
export function AddSubscriptionSheet({ open, onOpenChange, instructorId, onSuccess }: AddSubscriptionSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="rounded-2xl max-h-[85vh] overflow-y-auto">
        <SheetHeader>
        ...
        {loading ? (
          ...
          <div className="space-y-4 mt-4">
            ...
            {mandateUrl && (
              <div className="rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30 p-3 space-y-2">
