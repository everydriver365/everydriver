            ...
            >
              <div className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl p-2.5 text-center">
                  ...
                  <div>
                    ...
                    <div className="space-y-1.5">
                      {lessons.map((lesson) => (
                        <div
                          key={lesson.id}
                          className="flex items-center gap-2.5 py-2.5 px-3 bg-muted/30 rounded-2xl"
                        >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 py-2.5 text-xs font-medium text-primary hover:bg-muted/30 rounded-2xl transition-colors"
                >
                  View full schedule
