...
export default function Drive365Home({ afterLearningPaths }: { afterLearningPaths?: React.ReactNode } = {}) {
  ...
  return (
    <div style={{ width: "100%", overflow: "hidden", background: "#F6F6F8" }}>
      ...
      {/* Why Drive 365? — Desktop DSM Redesign */}
      <section className="d365-why-wrap hidden md:block" aria-label="Why Drive 365" style={{ background: "#EFF6FF", borderRadius: 8, border: "1px solid #BFDBFE", padding: "28px 32px", marginBottom: 32 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "center", marginBottom: 24 }}>
          <div>
            <div style={{ color: "#1A6FD4", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "1.5px", marginBottom: 6 }}>DRIVE 365</div>
            <h2 style={{ color: "#0A0E27", fontSize: 22, fontWeight: 800, letterSpacing: "-0.5px", margin: 0, lineHeight: 1.2 }}>
              WHY <span style={{ color: "#D12E2E" }}>DRIVE 365?</span>
            </h2>
          </div>
          <div style={{ borderLeft: "3px solid #1A6FD4", paddingLeft: 24 }}>
            <p style={{ fontSize: 12, lineHeight: 1.7, color: "#4B5563", margin: 0 }}>
              <span style={{ color: "#0A0E27", fontWeight: 700 }}>Why book through Drive 365?</span> There are so many benefits when booking through Drive 365 that are not available when booking direct with an instructor.
            </p>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10 }}>
          {/* Card 1 — Lessons booked */}
          <div style={{ background: "#FFFFFF", border: "1px solid #BFDBFE", borderRadius: 6, padding: "14px 12px", textAlign: "center" }}>
            <div style={{ color: "#D12E2E", fontSize: 18, fontWeight: 800, marginBottom: 3 }}>12,400+</div>
            <div style={{ color: "#6B7280", fontSize: 9 }}>Lessons booked</div>
          </div>
          {/* Card 2 — Reviews */}
          <div style={{ background: "#FFFFFF", border: "1px solid #BFDBFE", borderRadius: 6, padding: "14px 12px", textAlign: "center" }}>
            <div style={{ color: "#F59E0B", fontSize: 16, marginBottom: 3 }}>★★★★★</div>
            <div style={{ color: "#6B7280", fontSize: 9 }}>3,200 reviews</div>
          </div>
          {/* Card 3 — Pass rate */}
          <div style={{ background: "#FFFFFF", border: "1px solid #BFDBFE", borderRadius: 6, padding: "14px 12px", textAlign: "center" }}>
            <div style={{ color: "#1A6FD4", fontSize: 18, fontWeight: 800, marginBottom: 3 }}>94%</div>
            <div style={{ color: "#6B7280", fontSize: 9 }}>First-time pass rate</div>
          </div>
          {/* Card 4 — DVSA Approved */}
          <div style={{ background: "#FFFFFF", border: "1px solid #BFDBFE", borderRadius: 6, padding: "14px 12px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
            <div style={{ color: "#0A0E27", fontSize: 18, fontWeight: 800, letterSpacing: "0.5px", marginBottom: 3 }}>DVSA</div>
            <div style={{ color: "#6B7280", fontSize: 9 }}>Approved service</div>
          </div>
        </div>
      </section>

      {/* Why Drive 365? — Mobile fallback (original) */}
      <section className="d365-why-wrap md:hidden" aria-label="Why Drive 365">
