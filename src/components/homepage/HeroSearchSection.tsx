...
export function HeroSearchSection({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-end h-[360px] sm:h-[400px] lg:h-[540px] px-4 pb-10 sm:pb-8 lg:pb-10">
        {/* Search box */}
        <form
        ...
        >
          ...
          <div className="sm:hidden flex flex-col bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.15)] overflow-hidden w-full mx-auto">
            {/* Postcode */}
