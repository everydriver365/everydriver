...
export function PublicFAQsManager() {
  ...
  const saveFAQs = async () => {
    ...
    for (const faq of faqs) {
      ...
      if (faq.id.startsWith("temp-")) {
        await supabase.from("public_faqs").insert(faqData);
      } else {
        await supabase.from("public_faqs").update(faqData).eq("id", faq.id);
      }
    }
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-sm text-muted-foreground">
          Manage FAQs shown on the public /faqs page
        </p>
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1">
                        ...
                        <Input
                          ...
                          placeholder="e.g., How many lessons do I need?"
                        />
                      </div>
                      <div className="w-32">
