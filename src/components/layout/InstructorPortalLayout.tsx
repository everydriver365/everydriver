  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(async () => {
      ...
      const settingsPages: Array<{ label: string; href: string; keywords?: string }> = [
        { label: "Appearance & wallpaper", href: "/instructor/settings/appearance-layout", keywords: "appearance theme wallpaper colour color dark light layout look" },
        { label: "Dashboard layout", href: "/instructor/settings/appearance-layout", keywords: "layout tiles home dashboard" },
        { label: "Optional features", href: "/instructor/settings/appearance-layout", keywords: "feature toggles modules enable" },
        { label: "Plan & billing", href: "/instructor/settings/plan-billing", keywords: "plan billing subscription invoice upgrade" },
        { label: "Profile & contact details", href: "/instructor/settings/profile", keywords: "profile contact name email phone" },
        { label: "Login & security", href: "/instructor/settings/login-security", keywords: "password login security 2fa face id biometric" },
        { label: "Qualifications & credentials", href: "/instructor/settings/credentials", keywords: "adi badge qualifications credentials" },
        { label: "Working hours", href: "/instructor/settings/working-hours", keywords: "working hours availability open shifts" },
        { label: "Lesson length & buffer", href: "/instructor/settings/working-hours", keywords: "lesson length buffer bank holiday duration" },
        { label: "Google Calendar sync", href: "/instructor/settings/working-hours", keywords: "google calendar sync gcal" },
        { label: "Lesson reminders", href: "/instructor/settings/working-hours", keywords: "reminders sms email notifications" },
        { label: "Hourly rate", href: "/instructor/settings/rates-coverage", keywords: "rate price hourly cost" },
        { label: "Coverage area", href: "/instructor/settings/rates-coverage", keywords: "coverage area postcode radius travel" },
        { label: "Postcode rates", href: "/instructor/settings/rates-coverage", keywords: "postcode rates pricing" },
        { label: "Surcharges", href: "/instructor/settings/rates-coverage", keywords: "surcharge weekend bank holiday off peak service fee" },
        { label: "Booking mode", href: "/instructor/settings/how-pupils-book", keywords: "booking mode auto manual approval" },
        { label: "Deposit payments", href: "/instructor/settings/how-pupils-book", keywords: "deposit prepay" },
        { label: "Card service fee & QR codes", href: "/instructor/settings/payments", keywords: "card service fee qr commission" },
        { label: "Square account", href: "/instructor/settings/payments", keywords: "square card terminal payment" },
        { label: "Buy now pay later", href: "/instructor/settings/payments", keywords: "klarna clearpay bnpl finance" },
        { label: "Discount codes", href: "/instructor/settings/discounts-packages", keywords: "discount voucher promo coupon" },
        { label: "Lesson packages", href: "/instructor/settings/discounts-packages", keywords: "packages bundle hours" },
        { label: "Referral programme", href: "/instructor/settings/discounts-packages", keywords: "referral refer friend reward" },
        { label: "Pupil app branding", href: "/instructor/settings/branding", keywords: "branding logo colour color pupil app" },
        { label: "Terms & Conditions", href: "/instructor/settings/data-privacy", keywords: "terms conditions policy legal" },
        { label: "Cancellation policy", href: "/instructor/settings/data-privacy", keywords: "cancellation policy" },
        { label: "No-show policy", href: "/instructor/settings/data-privacy", keywords: "no show policy" },
        { label: "GDPR data retention", href: "/instructor/settings/data-privacy", keywords: "gdpr privacy data retention" },
        { label: "GPS tracking setup", href: "/instructor/settings/gps", keywords: "gps tracking obd telematics geotab" },
        { label: "Saved routes", href: "/instructor/settings/credentials", keywords: "saved routes" },
        { label: "Fuel & MPG", href: "/instructor/settings/credentials", keywords: "fuel mpg economy" },
        { label: "Mileage log", href: "/instructor/settings/credentials", keywords: "mileage log hmrc tax" },
        { label: "Notification preferences", href: "/instructor/settings/notifications", keywords: "notifications preferences email sms push" },
        { label: "Push notifications", href: "/instructor/settings/notifications", keywords: "push notifications mobile" },
        ...
        { label: "Data export & backup", href: "/instructor/settings/data-privacy", keywords: "export backup csv download" },
        { label: "Reset statistics", href: "/instructor/settings/data-privacy", keywords: "reset clear stats history" },
      ];
    ...
    return (
      ...
      >
        ...
        {isFullscreenMode ? (
          ...
          <>
            <OfflineBanner />
            <main className={`ios-scroll ${location.pathname === '/instructor' ? '' : 'px-2.5 py-4'}`} style={{ backgroundColor: 'transparent' }}>{children}</main>
