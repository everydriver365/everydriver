...
const SyllabusHubPage = lazy(() => import("@/pages/instructor/SyllabusHubPage"));
...
export const instructorPortalRoutes = (
  <>
    ...
    <Route path="/instructor/membership" element={<Navigate to="/instructor/settings/plan-billing" replace />} />
