...
serve(async (req) => {
  ...
  try {
    ...
    // 3. Send email notification to admins using fetch to Resend API
    let emailSent = false;
                ...
                <div style="background: #f9fafb; padding: 24px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
                  ...
                  <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                      ...
                      <td style="padding: 8px 0; color: #111827; font-weight: 600;">${enquiry.name}</td>
                    </tr>
                    <tr>
                      <td style="padding: 8px 0; color: #6b7280;">Contact:</td>
                      <td style="padding: 8px 0; color: #111827;">${enquiry.postcode}</td>
                    </tr>
                    <tr>
                      <td style="padding: 8px 0; color: #6b7280;">Email:</td>
                      <td style="padding: 8px 0; color: #111827;">${enquiry.address}</td>
                    </tr>
                  </table>
                  ...
                  <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                      <td style="padding: 8px 0; color: #6b7280; width: 120px;">Course Type:</td>
                      <td style="padding: 8px 0; color: #111827; font-weight: 600;">${enquiry.courseType.replace("-", " ")}</td>
                    </tr>
                    <tr>
                      <td style="padding: 8px 0; color: #6b7280;">Hours:</td>
                      <td style="padding: 8px 0; color: #111827;">${enquiry.requestedHours} hours</td>
                    </tr>
                    <tr>
                      <td style="padding: 8px 0; color: #6b7280;">Timing:</td>
                      <td style="padding: 8px 0; color: #111827;">${enquiry.preferredTiming.replace("-", " ")}</td>
                    </tr>
                  </table>
                  ` : ""}
                  ...
                  <p style="background: white; padding: 16px; border-radius: 8px; border: 1px solid #e5e7eb; color: #374151; margin: 0;">
                    ${enquiry.additionalNotes}
                  </p>
                  ` : ""}
    ...
    // 4. Get all active instructors to notify (skip for callbacks/general)
    const isCallback = enquiry.courseType === "callback" || enquiry.courseType === "general";
    let notifiedCount = 0;
    ...
    if (!isCallback) {
      ...
      if (instructors && instructors.length > 0) {
        // Send push notification to all instructors
