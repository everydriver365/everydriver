...
SELECT id, name, business_name, phone, email, bio, profile_image_url, car_image_url,
  ...
  custom_domain, custom_domain_verified, created_at, weekend_surcharge_amount,
  bank_holiday_surcharge_amount, odd_hours_surcharge_amount, odd_hours_start,
  odd_hours_end, klarna_enabled, clearpay_enabled, cash_payments_enabled,
  instant_bank_pay_enabled, school_skim_amount, adi_code_of_practice,
  is_network_placeholder, placeholder_district,
  preferred_language, additional_certifications, adaptations, bsl_signing
FROM instructors
