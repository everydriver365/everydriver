...
AS $function$
DECLARE
  allowed_fields TEXT[] := ARRAY['profile_image_url','date_of_birth','driver_number','theory_cert_number','phone','email','address','postcode','pickup_address','what3words','parent_portal_enabled','reminder_preferences'];
  field_name TEXT;
